...
const Entity$json = const {
  ...
  '3': const [Entity_NameEntry$json, Entity_DescriptionEntry$json, Entity_ContractsInfo$json, Entity_VotingProcesses$json, Entity_NewsFeedEntry$json, Entity_Media$json, Entity_Action$json, Entity_GatewayBootNode$json, Entity_GatewayUpdate$json, Entity_EntityReference$json, Entity_MetaEntry$json],
};
