...
var Proof = {
  ...
  fromJSON(object) {
    return {
      payload: isSet8(object.ca) ? { $case: "ca", ca: ProofCA.fromJSON(object.ca) } : isSet8(object.arbo) ? { $case: "arbo", arbo: ProofArbo.fromJSON(object.arbo) } : isSet8(object.zkSnark) ? { $case: "zkSnark", zkSnark: ProofZkSNARK.fromJSON(object.zkSnark) } : void 0
    };
  },
  toJSON(message) {
    const obj = {};
