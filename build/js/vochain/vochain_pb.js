...
var common_vote_pb = require('../common/vote_pb.js');
goog.object.extend(proto, common_vote_pb);
...
proto.dvote.types.v1.Tx.toObject = function(includeInstance, msg) {
  var f, obj = {
    vote: (f = msg.getVote()) && common_vote_pb.VoteEnvelope.toObject(includeInstance, f),
...
proto.dvote.types.v1.Tx.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new common_vote_pb.VoteEnvelope;
      reader.readMessage(value,common_vote_pb.VoteEnvelope.deserializeBinaryFromReader);
      msg.setVote(value);
      break;
    case 2:
...
proto.dvote.types.v1.Tx.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      common_vote_pb.VoteEnvelope.serializeBinaryToWriter
    );
  }
...
proto.dvote.types.v1.Tx.prototype.getVote = function() {
  return /** @type{?proto.dvote.types.v1.VoteEnvelope} */ (
    jspb.Message.getWrapperField(this, common_vote_pb.VoteEnvelope, 1));
};
...
proto.dvote.types.v1.SetProcessTx.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proof: (f = msg.getProof()) && common_vote_pb.Proof.toObject(includeInstance, f),
...
proto.dvote.types.v1.SetProcessTx.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new common_vote_pb.Proof;
      reader.readMessage(value,common_vote_pb.Proof.deserializeBinaryFromReader);
      msg.setProof(value);
      break;
    case 9:
...
proto.dvote.types.v1.SetProcessTx.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      common_vote_pb.Proof.serializeBinaryToWriter
    );
  }
...
proto.dvote.types.v1.SetProcessTx.prototype.getProof = function() {
  return /** @type{?proto.dvote.types.v1.Proof} */ (
    jspb.Message.getWrapperField(this, common_vote_pb.Proof, 8));
};
