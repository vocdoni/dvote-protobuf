...
class Treasurer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Treasurer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dvote.types.v1'), createEmptyInstance: create)
  ...
  factory Treasurer.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Treasurer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Treasurer clone() => Treasurer()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Treasurer copyWith(void Function(Treasurer) updates) => super.copyWith((message) => updates(message as Treasurer)) as Treasurer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Treasurer create() => Treasurer._();
  Treasurer createEmptyInstance() => create();
  static $pb.PbList<Treasurer> createRepeated() => $pb.PbList<Treasurer>();
  @$core.pragma('dart2js:noInline')
  static Treasurer getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Treasurer>(create);
  static Treasurer? _defaultInstance;
...
class SetAccountInfoTx extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $core.List<$core.int> get account => $_getN(3);
  @$pb.TagNumber(4)
  set account($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
...
class Process extends $pb.GeneratedMessage {
  ...
  factory Process({
    ...
    if (rollingCensusRoot != null) {
      _result.rollingCensusRoot = rollingCensusRoot;
    }
  ...
  @$pb.TagNumber(29)
  $core.List<$core.int> get rollingCensusRoot => $_getN(26);
  @$pb.TagNumber(29)
  set rollingCensusRoot($core.List<$core.int> v) { $_setBytes(26, v); }
  @$pb.TagNumber(29)
  $core.bool hasRollingCensusRoot() => $_has(26);
  @$pb.TagNumber(29)
  void clearRollingCensusRoot() => clearField(29);

  @$pb.TagNumber(30)
  $fixnum.Int64 get rollingCensusSize => $_getI64(27);
  @$pb.TagNumber(30)
  set rollingCensusSize($fixnum.Int64 v) { $_setInt64(27, v); }
  @$pb.TagNumber(30)
