...
const SourceNetworkId$json = const {
  ...
  '2': const [
    ...
    const {'1': 'AVAX', '2': 11},
    const {'1': 'POLYGON_MUMBAI', '2': 12},
    const {'1': 'OPTIMISM', '2': 13},
    const {'1': 'ARBITRUM', '2': 14},
  ],
};

/// Descriptor for `SourceNetworkId`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List sourceNetworkIdDescriptor = $convert.base64Decode('');
...
const ProofArbo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'leafWeight', '3': 3, '4': 1, '5': 12, '10': 'leafWeight'},
    const {'1': 'keyType', '3': 4, '4': 1, '5': 14, '6': '.dvote.types.v1.ProofArbo.KeyType', '10': 'keyType'},
    const {'1': 'votingWeight', '3': 5, '4': 1, '5': 12, '10': 'votingWeight'},
  ],
...
final $typed_data.Uint8List proofArboDescriptor = $convert.base64Decode('');
...
/// Descriptor for `Treasurer`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List treasurerDescriptor = $convert.base64Decode('CglUcmVhc3VyZXISGAoHYWRkcmVzcxgBIAEoDFIHYWRkcmVzcxIUCgVub25jZRgCIAEoDVIFbm9uY2U=');
...
final $typed_data.Uint8List newProcessTxDescriptor = $convert.base64Decode('CgxOZXdQcm9jZXNzVHgSLgoGdHh0eXBlGAEgASgOMhYuZHZvdGUudHlwZXMudjEuVHhUeXBlUgZ0eHR5cGUSFAoFbm9uY2UYAiABKA1SBW5vbmNlEjEKB3Byb2Nlc3MYAyABKAsyFy5kdm90ZS50eXBlcy52MS5Qcm9jZXNzUgdwcm9jZXNz');
...
final $typed_data.Uint8List setProcessTxDescriptor = $convert.base64Decode('');
...
const AdminTx$json = const {
  ...
  '2': const [
    ...
    const {'1': 'nonce', '3': 11, '4': 1, '5': 13, '10': 'nonce'},
  ],
  '8': const [
    const {'1': '_address'},
...
final $typed_data.Uint8List adminTxDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List registerKeyTxDescriptor = $convert.base64Decode('Cg1SZWdpc3RlcktleVR4EhQKBW5vbmNlGAEgASgNUgVub25jZRIcCglwcm9jZXNzSWQYAiABKAxSCXByb2Nlc3NJZBIrCgVwcm9vZhgDIAEoCzIVLmR2b3RlLnR5cGVzLnYxLlByb29mUgVwcm9vZhIWCgZuZXdLZXkYBCABKAxSBm5ld0tleRIWCgZ3ZWlnaHQYBSABKAlSBndlaWdodA==');
...
const SetKeykeeperTx$json = const {
  ...
  '2': const [
    const {'1': 'txtype', '3': 1, '4': 1, '5': 14, '6': '.dvote.types.v1.TxType', '10': 'txtype'},
    const {'1': 'nonce', '3': 2, '4': 1, '5': 13, '10': 'nonce'},
    const {'1': 'keykeeper', '3': 3, '4': 1, '5': 12, '10': 'keykeeper'},
  ],
};

/// Descriptor for `SetKeykeeperTx`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setKeykeeperTxDescriptor = $convert.base64Decode('Cg5TZXRLZXlrZWVwZXJUeBIuCgZ0eHR5cGUYASABKA4yFi5kdm90ZS50eXBlcy52MS5UeFR5cGVSBnR4dHlwZRIUCgVub25jZRgCIAEoDVIFbm9uY2USHAoJa2V5a2VlcGVyGAMgASgMUglrZXlrZWVwZXI=');
...
const Process$json = const {
  ...
  '2': const [
    ...
    const {'1': 'maxCensusSize', '3': 28, '4': 1, '5': 4, '10': 'maxCensusSize'},
    const {'1': 'rollingCensusRoot', '3': 29, '4': 1, '5': 12, '9': 9, '10': 'rollingCensusRoot', '17': true},
    const {'1': 'rollingCensusSize', '3': 30, '4': 1, '5': 4, '9': 10, '10': 'rollingCensusSize', '17': true},
    const {'1': 'nullifiersRoot', '3': 31, '4': 1, '5': 12, '9': 11, '10': 'nullifiersRoot', '17': true},
    const {'1': 'sourceNetworkContractAddr', '3': 32, '4': 1, '5': 12, '9': 12, '10': 'sourceNetworkContractAddr', '17': true},
    const {'1': 'tokenDecimals', '3': 33, '4': 1, '5': 13, '9': 13, '10': 'tokenDecimals', '17': true},
  ],
  '8': const [
    const {'1': '_censusURI'},
    const {'1': '_keyIndex'},
    ...
    const {'1': '_sourceNetworkContractAddr'},
    const {'1': '_tokenDecimals'},
  ],
};

/// Descriptor for `Process`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List processDescriptor = $convert.base64Decode('');
