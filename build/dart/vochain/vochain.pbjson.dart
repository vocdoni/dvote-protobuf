...
const Process$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sourceNetworkContractAddr', '3': 32, '4': 1, '5': 12, '9': 13, '10': 'sourceNetworkContractAddr', '17': true},
    const {'1': 'tokenDecimals', '3': 33, '4': 1, '5': 13, '9': 14, '10': 'tokenDecimals', '17': true},
  ],
  '8': const [
    const {'1': '_censusURI'},
    const {'1': '_keyIndex'},
...
final $typed_data.Uint8List processDescriptor = $convert.base64Decode('');
