...
const VoteEnvelope$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proof', '3': 4, '4': 1, '5': 11, '6': '.dvote.types.v1.Proof', '10': 'proof'},
    const {'1': 'votePackage', '3': 5, '4': 1, '5': 12, '10': 'votePackage'},
    const {'1': 'nullifier', '3': 6, '4': 1, '5': 12, '10': 'nullifier'},
    const {'1': 'encryptionKeyIndexes', '3': 7, '4': 3, '5': 13, '10': 'encryptionKeyIndexes'},
  ],
};
...
const Proof$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ethStg', '3': 3, '4': 1, '5': 11, '6': '.dvote.types.v1.ProofEthereumStorage', '9': 0, '10': 'ethStg'},
    const {'1': 'ethAcc', '3': 4, '4': 1, '5': 11, '6': '.dvote.types.v1.ProofEthereumAccount', '9': 0, '10': 'ethAcc'},
  ],
  '8': const [
    const {'1': 'proof'},
  ],
