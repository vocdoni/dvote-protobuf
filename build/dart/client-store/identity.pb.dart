...
class IdentitiesStore extends $pb.GeneratedMessage {
  ...
  factory IdentitiesStore.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IdentitiesStore.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  IdentitiesStore copyWith(void Function(IdentitiesStore) updates) =>
      super.copyWith((message) =>
          updates(message as IdentitiesStore)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IdentitiesStore create() => IdentitiesStore._();
  IdentitiesStore createEmptyInstance() => create();
  static $pb.PbList<IdentitiesStore> createRepeated() =>
      $pb.PbList<IdentitiesStore>();
  @$core.pragma('dart2js:noInline')
  static IdentitiesStore getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IdentitiesStore>(create);
...
class Identity_Peers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'dvote.types.v1'),
      createEmptyInstance: create)
    ..pc<$1.EntityReference>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entities', $pb.PbFieldType.PM,
        subBuilder: $1.EntityReference.create)
    ..pc<PeerIdentity>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identities',
        $pb.PbFieldType.PM,
        subBuilder: PeerIdentity.create)
    ..hasRequiredFields = false;

  Identity_Peers._() : super();
  factory Identity_Peers() => create();
  factory Identity_Peers.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Identity_Peers.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Identity_Peers copyWith(void Function(Identity_Peers) updates) =>
      super.copyWith((message) =>
          updates(message as Identity_Peers)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Identity_Peers create() => Identity_Peers._();
  Identity_Peers createEmptyInstance() => create();
  static $pb.PbList<Identity_Peers> createRepeated() =>
      $pb.PbList<Identity_Peers>();
  @$core.pragma('dart2js:noInline')
  static Identity_Peers getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Identity_Peers>(create);
...
class Identity_Claim extends $pb.GeneratedMessage {
  ...
  factory Identity_Claim.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Identity_Claim.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Identity_Claim copyWith(void Function(Identity_Claim) updates) =>
      super.copyWith((message) =>
          updates(message as Identity_Claim)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Identity_Claim create() => Identity_Claim._();
  Identity_Claim createEmptyInstance() => create();
  static $pb.PbList<Identity_Claim> createRepeated() =>
      $pb.PbList<Identity_Claim>();
  @$core.pragma('dart2js:noInline')
  static Identity_Claim getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Identity_Claim>(create);
...
class Identity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Identity_Type>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'type',
        $pb.PbFieldType.OE,
        defaultOrMaker: Identity_Type.ECDSA,
        valueOf: Identity_Type.valueOf,
        enumValues: Identity_Type.values)
    ..aOS(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alias')
  ...
  Identity copyWith(void Function(Identity) updates) =>
      super.copyWith((message) =>
          updates(message as Identity)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PeerIdentity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<PeerIdentity_Type>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'type',
        $pb.PbFieldType.OE,
        defaultOrMaker: PeerIdentity_Type.ECDSA,
        valueOf: PeerIdentity_Type.valueOf,
        enumValues: PeerIdentity_Type.values)
    ..aOS(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alias')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identityId', protoName: 'identityId')
    ..hasRequiredFields = false;
  ...
  factory PeerIdentity.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PeerIdentity.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PeerIdentity copyWith(void Function(PeerIdentity) updates) =>
      super.copyWith((message) =>
          updates(message as PeerIdentity)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PeerIdentity create() => PeerIdentity._();
  PeerIdentity createEmptyInstance() => create();
  static $pb.PbList<PeerIdentity> createRepeated() =>
      $pb.PbList<PeerIdentity>();
  @$core.pragma('dart2js:noInline')
  static PeerIdentity getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PeerIdentity>(create);
  static PeerIdentity _defaultInstance;

  @$pb.TagNumber(1)
  PeerIdentity_Type get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(PeerIdentity_Type v) {
    setField(1, v);
  }
