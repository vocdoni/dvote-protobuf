...
const Request$json = const {
  ...
  '2': const [
    ...
    const {'1': 'getElectionResultsWeight', '3': 9, '4': 1, '5': 11, '6': '.dvote.types.v2.GetElectionResultsWeight', '9': 0, '10': 'getElectionResultsWeight'},
    ...
    const {'1': 'getRawTransactionMessage', '3': 82, '4': 1, '5': 11, '6': '.dvote.types.v2.GetRawTransactionMessage', '9': 0, '10': 'getRawTransactionMessage'},
    const {'1': 'waitTransaction', '3': 83, '4': 1, '5': 11, '6': '.dvote.types.v2.WaitTransaction', '9': 0, '10': 'waitTransaction'},
  ],
  '8': const [
    const {'1': 'body'},
  ],
...
final $typed_data.Uint8List requestDescriptor = $convert.base64Decode('');
