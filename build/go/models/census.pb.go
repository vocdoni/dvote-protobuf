...
func (x *Proof) GetProofERC20() *StorageProofERC20 {
	if x, ok := x.GetBody().(*Proof_ProofERC20); ok {
		return x.ProofERC20
	}
	return nil
}

func (x *Proof) GetProofERC721() *StorageProofERC721 {
	if x, ok := x.GetBody().(*Proof_ProofERC721); ok {
		return x.ProofERC721
	}
	return nil
}

func (x *Proof) GetProofERC1155() *StorageProofERC1155 {
	if x, ok := x.GetBody().(*Proof_ProofERC1155); ok {
		return x.ProofERC1155
	}
	return nil
}

func (x *Proof) GetProofERC777() *StorageProofERC777 {
	if x, ok := x.GetBody().(*Proof_ProofERC777); ok {
		return x.ProofERC777
	}
	return nil
}

func (x *Proof) GetProofMiniMe() *StorageProofMiniMe {
	if x, ok := x.GetBody().(*Proof_ProofMiniMe); ok {
		return x.ProofMiniMe
	}
	return nil
}
...
type Proof_ProofERC20 struct {
	ProofERC20 *StorageProofERC20 `protobuf:"bytes,21,opt,name=proofERC20,proto3,oneof"`
}

type Proof_ProofERC721 struct {
	ProofERC721 *StorageProofERC721 `protobuf:"bytes,22,opt,name=proofERC721,proto3,oneof"`
}

type Proof_ProofERC1155 struct {
	ProofERC1155 *StorageProofERC1155 `protobuf:"bytes,23,opt,name=proofERC1155,proto3,oneof"`
}

type Proof_ProofERC777 struct {
	ProofERC777 *StorageProofERC777 `protobuf:"bytes,24,opt,name=proofERC777,proto3,oneof"`
}

type Proof_ProofMiniMe struct {
	ProofMiniMe *StorageProofMiniMe `protobuf:"bytes,30,opt,name=proofMiniMe,proto3,oneof"`
}
...
func (*Proof_ProofERC20) isProof_Body() {}

func (*Proof_ProofERC721) isProof_Body() {}

func (*Proof_ProofERC1155) isProof_Body() {}

func (*Proof_ProofERC777) isProof_Body() {}

func (*Proof_ProofMiniMe) isProof_Body() {}
...
var file_protocol_census_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x51, 0x0a, 0x11, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66,
	0x45, 0x52, 0x43, 0x32, 0x30, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	,
...
var file_protocol_census_proto_depIdxs = []int32{
	...
	10, // 8: dvote.types.v2.Proof.none:type_name -> dvote.types.v2.ProofNone
	11, // 9: dvote.types.v2.Proof.arbo:type_name -> dvote.types.v2.ProofArbo
	12, // 10: dvote.types.v2.Proof.csp:type_name -> dvote.types.v2.ProofCSP
	13, // 11: dvote.types.v2.Proof.proofERC20:type_name -> dvote.types.v2.StorageProofERC20
	14, // 12: dvote.types.v2.Proof.proofERC721:type_name -> dvote.types.v2.StorageProofERC721
	15, // 13: dvote.types.v2.Proof.proofERC1155:type_name -> dvote.types.v2.StorageProofERC1155
	16, // 14: dvote.types.v2.Proof.proofERC777:type_name -> dvote.types.v2.StorageProofERC777
	17, // 15: dvote.types.v2.Proof.proofMiniMe:type_name -> dvote.types.v2.StorageProofMiniMe
	18, // 16: dvote.types.v2.Proof.zkSnark:type_name -> dvote.types.v2.ProofZkSnark
	19, // 17: dvote.types.v2.ProofZkSnark.proof1k:type_name -> dvote.types.v2.ProofZkSnark.Poseidon1kCensus
	20, // 18: dvote.types.v2.ProofZkSnark.proof50k:type_name -> dvote.types.v2.ProofZkSnark.Poseidon50kCensus
	21, // 19: dvote.types.v2.ProofZkSnark.proof250k:type_name -> dvote.types.v2.ProofZkSnark.Poseidon250kCensus
...
func file_protocol_census_proto_init() {
	...
	file_protocol_census_proto_msgTypes[9].OneofWrappers = []interface{}{
		...
		(*Proof_Arbo)(nil),
		(*Proof_Csp)(nil),
		(*Proof_ProofERC20)(nil),
		(*Proof_ProofERC721)(nil),
		(*Proof_ProofERC1155)(nil),
		(*Proof_ProofERC777)(nil),
		(*Proof_ProofMiniMe)(nil),
		(*Proof_ZkSnark)(nil),
	}
