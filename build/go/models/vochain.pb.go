...
func (ProofCA_Type) EnumDescriptor() ([]byte, []int) {
	return file_vochain_vochain_proto_rawDescGZIP(), []int{4, 0}
}
...
type SignedTx struct {
	...
	// if the signature has been performed on the base64 representation of the tx bytes.
	// by default this bool should not be used (only for special cases where the signing
	// provider cannot perform signatures over binary data).
	B64Encoded *bool `protobuf:"varint,3,opt,name=b64encoded,proto3,oneof" json:"b64encoded,omitempty"`
}
...
func (x *SignedTx) GetB64Encoded() bool {
	if x != nil && x.B64Encoded != nil {
		return *x.B64Encoded
	}
	return false
}
...
var file_vochain_vochain_proto_rawDesc = []byte{
	...
	0x08, 0x73, 0x69, 0x62, 0x6c, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xec, 0x01, 0x0a, 0x07, 0x50, 0x72,
	...
	0x53, 0x41, 0x4c, 0x54, 0x45, 0x44, 0x10, 0x04, 0x22, 0x42, 0x0a, 0x08, 0x43, 0x41, 0x62, 0x75,
	...
	0x61, 0x64, 0x22, 0x7f, 0x0a, 0x08, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x54, 0x78, 0x12, 0x0e,
	...
	0x01, 0x12, 0x23, 0x0a, 0x0a, 0x62, 0x36, 0x34, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x48, 0x01, 0x52, 0x0a, 0x62, 0x36, 0x34, 0x65, 0x6e, 0x63, 0x6f,
	0x64, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x62, 0x36, 0x34, 0x65, 0x6e, 0x63, 0x6f,
	0x64, 0x65, 0x64, 0x22, 0x87, 0x01, 0x0a, 0x0c, 0x4e, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x63, 0x65,
	...
	0x73, 0x22, 0xab, 0x04, 0x0a, 0x07, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x54, 0x78, 0x12, 0x2e, 0x0a,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x88, 0x01, 0x01, 0x12, 0x29, 0x0a, 0x0d, 0x63, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x4b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0c, 0x48, 0x01, 0x52, 0x0d, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x4b,
	0x65, 0x79, 0x88, 0x01, 0x01, 0x12, 0x37, 0x0a, 0x14, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0c, 0x48, 0x02, 0x52, 0x14, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f,
	...
	0x69, 0x63, 0x4b, 0x65, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x03, 0x52, 0x13, 0x65,
	...
	,
	...
	0x79, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x72, 0x65, 0x76, 0x65, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x22,
	0xc9, 0x0a, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x70,
	...
	0x75, 0x73, 0x55, 0x52, 0x49, 0x88, 0x01, 0x01, 0x12, 0x26, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x6d,
	0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x4b, 0x65, 0x79, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x4b, 0x65, 0x79, 0x73,
	...
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65,
	0x76, 0x65, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a,
	0x72, 0x65, 0x76, 0x65, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x73, 0x12, 0x1f, 0x0a, 0x08, 0x6b, 0x65,
	...
	0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xa5, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x63, 0x65,
	...
	0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x22, 0xc2,
	...
	0x6f, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xa4, 0x01, 0x0a, 0x0d,
	...
	0x74, 0x79, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x70, 0x72, 0x6f, 0x63,
	0x65, 0x73, 0x73, 0x49, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
	0x49, 0x64, 0x22, 0x2c, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	0x03, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x69, 0x64, 0x73, 0x2a, 0x97, 0x02, 0x0a, 0x06, 0x54, 0x78,
	...
	0x53, 0x10, 0x0c, 0x2a, 0x61, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x53, 0x74,
	...
	0x55, 0x4c, 0x54, 0x53, 0x10, 0x05, 0x2a, 0xb9, 0x01, 0x0a, 0x0f, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x10, 0x09, 0x2a, 0xa2, 0x01, 0x0a, 0x0c, 0x43, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x4f, 0x72, 0x69,
...
var file_vochain_vochain_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_vochain_vochain_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_vochain_vochain_proto_goTypes = []interface{}{
	...
	(ProofCA_Type)(0),            // 4: dvote.types.v1.ProofCA.Type
...
var file_vochain_vochain_proto_depIdxs = []int32{
	6,  // 0: dvote.types.v1.VoteEnvelope.proof:type_name -> dvote.types.v1.Proof
	7,  // 1: dvote.types.v1.Proof.graviton:type_name -> dvote.types.v1.ProofGraviton
	8,  // 2: dvote.types.v1.Proof.iden3:type_name -> dvote.types.v1.ProofIden3
	11, // 3: dvote.types.v1.Proof.ethereumStorage:type_name -> dvote.types.v1.ProofEthereumStorage
	12, // 4: dvote.types.v1.Proof.ethereumAccount:type_name -> dvote.types.v1.ProofEthereumAccount
	9,  // 5: dvote.types.v1.Proof.ca:type_name -> dvote.types.v1.ProofCA
	4,  // 6: dvote.types.v1.ProofCA.type:type_name -> dvote.types.v1.ProofCA.Type
	10, // 7: dvote.types.v1.ProofCA.bundle:type_name -> dvote.types.v1.CAbundle
	5,  // 8: dvote.types.v1.Tx.vote:type_name -> dvote.types.v1.VoteEnvelope
	15, // 9: dvote.types.v1.Tx.newProcess:type_name -> dvote.types.v1.NewProcessTx
	17, // 10: dvote.types.v1.Tx.admin:type_name -> dvote.types.v1.AdminTx
	16, // 11: dvote.types.v1.Tx.setProcess:type_name -> dvote.types.v1.SetProcessTx
	0,  // 12: dvote.types.v1.NewProcessTx.txtype:type_name -> dvote.types.v1.TxType
	18, // 13: dvote.types.v1.NewProcessTx.process:type_name -> dvote.types.v1.Process
	0,  // 14: dvote.types.v1.SetProcessTx.txtype:type_name -> dvote.types.v1.TxType
	1,  // 15: dvote.types.v1.SetProcessTx.status:type_name -> dvote.types.v1.ProcessStatus
	6,  // 16: dvote.types.v1.SetProcessTx.proof:type_name -> dvote.types.v1.Proof
	27, // 17: dvote.types.v1.SetProcessTx.results:type_name -> dvote.types.v1.ProcessResult
	0,  // 18: dvote.types.v1.AdminTx.txtype:type_name -> dvote.types.v1.TxType
	1,  // 19: dvote.types.v1.Process.status:type_name -> dvote.types.v1.ProcessStatus
	19, // 20: dvote.types.v1.Process.envelopeType:type_name -> dvote.types.v1.EnvelopeType
	20, // 21: dvote.types.v1.Process.mode:type_name -> dvote.types.v1.ProcessMode
	21, // 22: dvote.types.v1.Process.voteOptions:type_name -> dvote.types.v1.ProcessVoteOptions
	3,  // 23: dvote.types.v1.Process.censusOrigin:type_name -> dvote.types.v1.CensusOrigin
	27, // 24: dvote.types.v1.Process.results:type_name -> dvote.types.v1.ProcessResult
	2,  // 25: dvote.types.v1.Process.sourceNetworkId:type_name -> dvote.types.v1.SourceNetworkId
