...
var file_vochain_vochain_proto_rawDesc = []byte{
	...
	0x0a, 0x5f, 0x72, 0x65, 0x76, 0x65, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x22, 0xfe, 0x09, 0x0a, 0x07,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x88, 0x01, 0x01, 0x42, 0x0c, 0x0a, 0x0a, 0x5f,
	...
	0x0b, 0x0a, 0x09, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xb8, 0x01, 0x0a,
	...
	0x6d, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xa5, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x63,
	...
	0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x22,
	...
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x22, 0x67, 0x0a, 0x09, 0x56, 0x61, 0x6c, 0x69,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x70, 0x6f, 0x77, 0x65, 0x72, 0x12, 0x12, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x22, 0xc8, 0x01, 0x0a, 0x04, 0x56, 0x6f, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65,
	...
	0x65, 0x78, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xdd, 0x03, 0x0a,
	...
	0x69, 0x74, 0x79, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x70, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x49, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x49, 0x64, 0x22, 0x2c, 0x0a, 0x0e, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x20, 0x03, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x69, 0x64, 0x73, 0x2a, 0x97, 0x02, 0x0a, 0x06, 0x54,
	...
	0x54, 0x53, 0x10, 0x0c, 0x2a, 0x61, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x53,
	...
	0x53, 0x55, 0x4c, 0x54, 0x53, 0x10, 0x05, 0x2a, 0xa2, 0x01, 0x0a, 0x0c, 0x43, 0x65, 0x6e, 0x73,
...
var file_vochain_vochain_proto_goTypes = []interface{}{
	...
	(ProofCA_Type)(0),            // 3: dvote.types.v1.ProofCA.Type
	(*VoteEnvelope)(nil),         // 4: dvote.types.v1.VoteEnvelope
	(*Proof)(nil),                // 5: dvote.types.v1.Proof
	(*ProofGraviton)(nil),        // 6: dvote.types.v1.ProofGraviton
	(*ProofIden3)(nil),           // 7: dvote.types.v1.ProofIden3
	(*ProofCA)(nil),              // 8: dvote.types.v1.ProofCA
	(*CAbundle)(nil),             // 9: dvote.types.v1.CAbundle
	(*ProofEthereumStorage)(nil), // 10: dvote.types.v1.ProofEthereumStorage
	(*ProofEthereumAccount)(nil), // 11: dvote.types.v1.ProofEthereumAccount
	(*Tx)(nil),                   // 12: dvote.types.v1.Tx
	(*SignedTx)(nil),             // 13: dvote.types.v1.SignedTx
	(*NewProcessTx)(nil),         // 14: dvote.types.v1.NewProcessTx
	(*SetProcessTx)(nil),         // 15: dvote.types.v1.SetProcessTx
	(*AdminTx)(nil),              // 16: dvote.types.v1.AdminTx
	(*Process)(nil),              // 17: dvote.types.v1.Process
	(*EnvelopeType)(nil),         // 18: dvote.types.v1.EnvelopeType
	(*ProcessMode)(nil),          // 19: dvote.types.v1.ProcessMode
	(*ProcessVoteOptions)(nil),   // 20: dvote.types.v1.ProcessVoteOptions
	(*OracleList)(nil),           // 21: dvote.types.v1.OracleList
	(*ValidatorList)(nil),        // 22: dvote.types.v1.ValidatorList
...
var file_vochain_vochain_proto_depIdxs = []int32{
	5,  // 0: dvote.types.v1.VoteEnvelope.proof:type_name -> dvote.types.v1.Proof
	6,  // 1: dvote.types.v1.Proof.graviton:type_name -> dvote.types.v1.ProofGraviton
	7,  // 2: dvote.types.v1.Proof.iden3:type_name -> dvote.types.v1.ProofIden3
	10, // 3: dvote.types.v1.Proof.ethereumStorage:type_name -> dvote.types.v1.ProofEthereumStorage
	11, // 4: dvote.types.v1.Proof.ethereumAccount:type_name -> dvote.types.v1.ProofEthereumAccount
	8,  // 5: dvote.types.v1.Proof.ca:type_name -> dvote.types.v1.ProofCA
	3,  // 6: dvote.types.v1.ProofCA.type:type_name -> dvote.types.v1.ProofCA.Type
	9,  // 7: dvote.types.v1.ProofCA.bundle:type_name -> dvote.types.v1.CAbundle
	4,  // 8: dvote.types.v1.Tx.vote:type_name -> dvote.types.v1.VoteEnvelope
	14, // 9: dvote.types.v1.Tx.newProcess:type_name -> dvote.types.v1.NewProcessTx
	16, // 10: dvote.types.v1.Tx.admin:type_name -> dvote.types.v1.AdminTx
	15, // 11: dvote.types.v1.Tx.setProcess:type_name -> dvote.types.v1.SetProcessTx
	0,  // 12: dvote.types.v1.NewProcessTx.txtype:type_name -> dvote.types.v1.TxType
	17, // 13: dvote.types.v1.NewProcessTx.process:type_name -> dvote.types.v1.Process
	...
	5,  // 16: dvote.types.v1.SetProcessTx.proof:type_name -> dvote.types.v1.Proof
	26, // 17: dvote.types.v1.SetProcessTx.results:type_name -> dvote.types.v1.ProcessResult
	...
	18, // 20: dvote.types.v1.Process.envelopeType:type_name -> dvote.types.v1.EnvelopeType
	19, // 21: dvote.types.v1.Process.mode:type_name -> dvote.types.v1.ProcessMode
	20, // 22: dvote.types.v1.Process.voteOptions:type_name -> dvote.types.v1.ProcessVoteOptions
	2,  // 23: dvote.types.v1.Process.censusOrigin:type_name -> dvote.types.v1.CensusOrigin
	26, // 24: dvote.types.v1.Process.results:type_name -> dvote.types.v1.ProcessResult
	23, // 25: dvote.types.v1.ValidatorList.validators:type_name -> dvote.types.v1.Validator
