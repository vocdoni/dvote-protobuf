...
func (x *MintTokensTx) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *SendTokensTx) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_vochain_vochain_proto_rawDesc = []byte{
	...
	0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x53, 0x10, 0x05, 0x2a, 0xb9, 0x01,
	...
	0x47, 0x4e, 0x41, 0x4c, 0x49, 0x4e, 0x47, 0x10, 0x09, 0x2a, 0xa2, 0x01, 0x0a, 0x0c, 0x43, 0x65,
