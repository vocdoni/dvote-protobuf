...
type CensusOffchainType int32

const (
	CensusOffchainType_UNKNOWN_OFFCHAIN_CENSUS_TYPE CensusOffchainType = 0
	CensusOffchainType_ARBO_BLAKE2B                 CensusOffchainType = 1
)

// Enum value maps for CensusOffchainType.
var (
	CensusOffchainType_name = map[int32]string{
		0: "UNKNOWN_OFFCHAIN_CENSUS_TYPE",
		1: "ARBO_BLAKE2B",
	}
	CensusOffchainType_value = map[string]int32{
		"UNKNOWN_OFFCHAIN_CENSUS_TYPE": 0,
		"ARBO_BLAKE2B":                 1,
	}
)

func (x CensusOffchainType) Enum() *CensusOffchainType {
	p := new(CensusOffchainType)
	*p = x
	return p
}

func (x CensusOffchainType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CensusOffchainType) Descriptor() protoreflect.EnumDescriptor {
	return file_protocol_enums_proto_enumTypes[1].Descriptor()
}

func (CensusOffchainType) Type() protoreflect.EnumType {
	return &file_protocol_enums_proto_enumTypes[1]
}

func (x CensusOffchainType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CensusOffchainType.Descriptor instead.
func (CensusOffchainType) EnumDescriptor() ([]byte, []int) {
...
var file_protocol_enums_proto_rawDesc = []byte{
	...
	0x10, 0x05, 0x2a, 0x48, 0x0a, 0x12, 0x43, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x4f, 0x66, 0x66, 0x63,
	0x68, 0x61, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x1c, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x5f, 0x4f, 0x46, 0x46, 0x43, 0x48, 0x41, 0x49, 0x4e, 0x5f, 0x43, 0x45, 0x4e,
	0x53, 0x55, 0x53, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x41, 0x52,
	0x42, 0x4f, 0x5f, 0x42, 0x4c, 0x41, 0x4b, 0x45, 0x32, 0x42, 0x10, 0x01, 0x42, 0x28, 0x5a, 0x26,
...
var file_protocol_enums_proto_goTypes = []interface{}{
	...
	(CensusOffchainType)(0), // 1: dvote.types.v2.CensusOffchainType
}
